...
func Load() {
	...
	files := []string{"dropper", "dropper-focus", "eraser", "eraser-focus", "fill", "fill-focus", "insert", "insert-focus", "select", "select-focus", "cselect", "cselect-focus", "lselect", "lselect-focus", "wand", "wand-focus", "loading", "missing"}
